...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    submit: function submit() {
      this.$inertia.put(this.route('user.update', this.user), this.form).then(function (res) {})["catch"](function (error) {
        console.log(error);
      });
    },
    destroy: function destroy() {
      if (confirm('Delete this user?')) {
        this.$inertia["delete"](this.route('user.destroy', this.user), this.form).then(function (res) {})["catch"](function (error) {
          console.log(error);
        });
      }
    }
            ...
            _c(
              ...
              [
                ...
                _c("div", { staticClass: "mb-3 row" }, [
                  _c(
                    "label",
                    { staticClass: "col-md-4", attrs: { for: "email" } },
                    [_vm._v("Email")]
                  ),
                  _vm._v(" "),
                  _c("div", { staticClass: "col-md-8" }, [
                ...
                _c("div", { staticClass: "mb-3 row" }, [
                  _c(
                    "label",
                    { staticClass: "col-md-4", attrs: { for: "role" } },
                    [_vm._v("Role")]
                  ),
                  _vm._v(" "),
                  _c("div", { staticClass: "col-md-8" }, [
